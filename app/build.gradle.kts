...
dependencies {
    ...
    //implementation(project(":prochargelib"))  // uncomment to use jar project directly
    //implementation(files("../prochargelib/src/libs/prochargelib.jar"))            // uncomment to link jar file
